...
@ControllerAdvice
public class CustomerConnectException extends RuntimeException {

	private static final long serialVersionUID = 1L;

	public CustomerConnectException() {
		super();
	}

	public CustomerConnectException(String message, Throwable cause) {
		super(message, cause);
	}

	public CustomerConnectException(String message) {
		super(message);
	}
