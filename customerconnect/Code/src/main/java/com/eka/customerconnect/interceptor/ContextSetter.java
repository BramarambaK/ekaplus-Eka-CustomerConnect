package com.eka.customerconnect.interceptor;
...
import com.eka.customerconnect.commons.ContextProvider;
import com.eka.customerconnect.constant.GlobalConstants;
import com.eka.customerconnect.model.ContextInfo;
...
public class ContextSetter implements AsyncHandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		logger.info(Logger.EVENT_SUCCESS, "********* CustomerConnect-PreHandle Started......"+"Request Details: " + requestMethod + " " + requestURI);
	...
	public  void afterCompletion(HttpServletRequest request,
		...
		logger.info(Logger.EVENT_SUCCESS, "********* CustomerConnect User Request completed......"+"Request Details: " + requestMethod + " " + requestURI);
		removeContext();
		MDC.clear();
	}
